...
A writer:
  ...
  - MUST include either exactly one `d` or exactly one `h` field.
    - if `d` is included:
      ...
      "Other" (C*), "Zl" or "Zp" General Categories.
...
A reader:
  ...
  - MUST fail the payment if the `d` field is not a valid UTF-8 string without characters in the unicode "Cc", "Cf", "Cs", "Co", "Zl", or "Zp" General Category.
